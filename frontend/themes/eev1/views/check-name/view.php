...
/* @var $model frontend\models\CheckNameSearchForm */
...
?>
    ...
    <div class="header">
        <div class="container">
			...
			<?php $form = ActiveForm::begin(['enableClientScript' => false, 'action'=>Url::to(['check-name/index']), 'options'=>['class'=>'form-inline header-form', 'id'=>'nameCheckForm']]); ?>
                ...
                <button type="submit" class="btn btn-primary">不可用</button>
            <?php ActiveForm::end(); ?>
        </div>
    </div>
            ...
            <div class="name-detail">
                ...
                <table class="table table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($model->nameList as $key=>$oneHW):?>
                            <?php if ($key % 2  == 0):?>
                            <tr>
                            <?php endif;?>
                                <td><?= $model->city.$oneHW['title'].$model->industry.'有限公司'; ?></td>
                                <td>
                                	<?= CommonConst::getName($oneHW['rate'], 'PassRate'); ?>
                                    <img class="hide" src="<?= $this->theme->baseUrl;?>/images/icon<?= mt_rand(12, 13); ?>.png"> 
                                </td>
                            <?php if ($key % 2  == 1):?>
		                        </tr>
                            <?php endif;?>
