...
?>
    ...
    <div class="named-tool">
    	<?php $form = ActiveForm::begin(['action'=>Url::to(['name/index', 'btype'=>'wap']), 'options'=>['class'=>'form-inline']]); ?>
            <div class="form-group">
                <a href="javascript:;" class="open-popup" data-target="#popup-city">
                	<?= Html::activeTextInput($model, 'city', ['class'=>'form-control', 'placeholder'=>'北京', 'required'=>true, 'readonly'=>true, 'onfocus'=>'this.blur()', 'id'=>'inputCity']); ?>
            ...
            <div class="form-group">
                <a href="javascript:;" class="open-popup" data-target="#popup-industry">
                	<?= Html::activeTextInput($model, 'industry', ['class'=>'form-control', 'placeholder'=>'请输入行业，如：科技', 'required'=>true, 'readonly'=>true, 'onfocus'=>'this.blur()', 'id'=>'inputIndustry']); ?>
                    <span class="select-btn">
                        <i class="icon-down"></i>
                    </span>
                </a>
            ...
            <div class="form-group">
                <button type="submit" class="btn">推荐名字</button>
            </div>
        <?php ActiveForm::end(); ?>
    </div>
    <div class="warp">
        <div class="cell name-detail">
            <div class="container">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($model->hotwords as $key=>$oneHW):?>
                            <tr>
                                ...
                                <td>
                                    <img src="<?= $this->theme->baseUrl;?>/images/icon<?= mt_rand(15, 16); ?>.png"> </td>
	                        </tr>
                        <?php endforeach;?>
                    </tbody>
                </table>
                <div class="text-center">
                    <a href="#" onclick="location.reload()" class="btn replace-btn">
                        <img src="<?= $this->theme->baseUrl;?>/images/icon17.png">换一批</a>
                </div>
            </div>
        </div>
        <div class="cell">
