...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?= \Yii::$app->homeUrl ?>" class="logo">企好名管理后台</a>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?= Yii::$app->user->identity->u_displayName; ?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        <?= Yii::$app->user->identity->u_displayName; ?>
                                        <small><?= Yii::$app->user->identity->u_email; ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?= \yii\helpers\Url::to(['/site/logout']) ?>"
                                           class="btn btn-default btn-flat" data-method="post">退出</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
    ...
    <footer class="main-footer">
        Powered by <strong><a href="http://www.go9999.com">企好名.Tech.Team</a></strong>
    </footer>
</div>
<!-- ./wrapper -->
